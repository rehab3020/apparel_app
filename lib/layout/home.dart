...
import 'package:market_apparel/modules/basic_screens/favourites_screen.dart';
import 'package:market_apparel/modules/login/login.dart';

import '../modules/basic_screens/cart_screen.dart';
import '../modules/basic_screens/home_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: bottomNavigation(
        ...
        function: (index) {
          setState(() {
            index==2?_currentIndex=0:_currentIndex = index;
